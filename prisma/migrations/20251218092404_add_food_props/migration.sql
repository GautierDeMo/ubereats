/*
  ...
  - Added the required column `readyType` to the `Food` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "readyType" INTEGER NOT NULL;
